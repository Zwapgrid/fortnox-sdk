...
{
    [TestClass]
    public class SalaryTransactionsTests : ConnectorTestsBase
    {
        readonly ISalaryTransactionsConnector _connector;

        public SalaryTransactionsTests()
        {
        ...
        int GetSalaryTransactionId()
        {
            ...
            if (findResult.Entities.Any())
                return findResult.Entities.First().SalaryRow;
