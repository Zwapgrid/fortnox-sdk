...
namespace FortnoxAPILibrary.Tests
{
    ...
    public class SupplierInvoiceTests
    {
        ...
        public void GetSupplierInvoices()
        {
            ...
            connector.SortBy = Sort.By.SupplierInvoice.InvoiceDate;
            connector.SortOrder = Sort.Order.Descending;
            var supplierInvoices = connector.Find().Entities;
            ...
            supplierInvoices = connector.Find().Entities;
